...
Next, practice using creating a persistent volume to share between Jenkins instances in [part 2](https://github.com/shekhar2010us/docker_bootcamp/blob/master/exercise/exercise6.2-jenkins-part2.md)